...
Выше я написал, что нужное кол-во inode создаётся автоматически при создании файловой системы. Однако пользователь самостоятельно может указать нужное количество inode:
...
Вы можете не указывать точное количество inode, а указать количество байт в
одном inode:
